...
2. [The JSON file](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#2-the-json-file)
	- [prefix](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#a-prefix)
	- [agent](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#b-agent)
	- [activity](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#c-activity)
	- [entity](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#d-entity)
	...
	- [wasInformedBy](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#e-wasinformedby)
	- [wasGeneratedBy](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#f-wasgeneratedby)
	- [used](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#g-used)
	- [hadMember](https://github.com/End-to-end-provenance/ExtendedProvJson/blob/master/JSON-format.md#h-hadmember)
